# 🐍 PS3: Python Problem Solving Journey

Welcome to my **100-day Python Problem Solving Challenge (PS3)** 💪  
This repo contains 400+ problems from **W3Resource, HackerRank, and real-life scripts** —  
solved purely for skill mastery, not for hype 🚀

---

## 🧠 Objective
- Rebuild confidence in Python.
- Master core logic (Strings → OOP → File Handling).
...
## 💚 Daily Progress
✅ Day 1 → Basics + Strings  
✅ Day 10 → Loops + Functions  
✅ Day 50 → File I/O + OOP  
✅ Day 100 → 400+ Problems Done  
